...
Credit: This is a small python project where I follow along on [python projects roadmap](https://roadmap.sh/projects/task-tracker)

## Setup

Use git clone *this url* or download the **task_cli.py** and put it into a new folder.  
